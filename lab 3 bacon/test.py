...
def test_acted_together_mine():
    # Simple test, different actors in same movie
    actor1 = 2876
    actor2 = 1640
...
def test_tiny_bacon_number_0():
    # Actors with Bacon number of 0 in db_tiny
    n = 0
    expected = {4724}
...
def test_tiny_bacon_number_1():
    # Actors with Bacon number of 1 in db_tiny
    n = 1
    expected = {2876, 1532}
...
def test_tiny_bacon_number_2():
    # Actors with Bacon number of 2 in db_tiny
    n = 2
    expected = {1640}
...
def test_bacon_path_mine():
    # Bacon path, tiny database, does not exist
    actor_id = 1640
